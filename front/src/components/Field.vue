<template>
  <b-container>
    ...
    <b-row>
      ...
      <b-col><b-form-file @change="onFileChange" accept="image/*" ref="file Input"></b-form-file></b-col>
    </b-row>
    <b-row v-if="url">
      <b-col sm="1"></b-col>
      <b-col sm="3"><img :src="url" style="max-width: 200px; max-height: 20 0px; object-fit: cover;"/></b-col>
      <b-col><b-button @click="removeImage"><b-icon-trash></b-icon-trash></ b-button></b-col>
    </b-row>
    <b-row>
      <b-col sm="1"><b-button @click="upload" :disabled="uploadState.disabl ed"><b-icon-pencil-square :animation="uploadState.animate"></b-icon-pencil-square></b-button></b-col>
      ...
      <b-col sm="1">
        <b-button @click="changeLocState">
          ...
          <b-iconstack v-else>
            <b-icon-geo stacked></b-icon-geo><b-icon-slash-circle stacked s cale="1.5"></b-icon-slash-circle>
          </b-iconstack>
        </b-button>
      </b-col>
    </b-row>
